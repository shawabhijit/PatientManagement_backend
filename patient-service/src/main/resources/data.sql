...
SELECT '223e4567-e89b-12d3-a456-426614174011',
    ...
    SELECT 1
    FROM patient
    WHERE id = '223e4567-e89b-12d3-a456-426614174011'
);
...
SELECT '223e4567-e89b-12d3-a456-426614174012',
    ...
    SELECT 1
    FROM patient
    WHERE id = '223e4567-e89b-12d3-a456-426614174012'
);
...
SELECT '223e4567-e89b-12d3-a456-426614174013',
    ...
    SELECT 1
    FROM patient
    WHERE id = '223e4567-e89b-12d3-a456-426614174013'
);
...
SELECT '223e4567-e89b-12d3-a456-426614174014',
    ...
    SELECT 1
    FROM patient
    WHERE id = '223e4567-e89b-12d3-a456-426614174014'
);
